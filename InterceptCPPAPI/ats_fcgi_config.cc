...
{
  FcgiPluginData *plugin_data = new FcgiPluginData();
...
FcgiPluginConfig *
FcgiPluginData::getGlobalConfigObj()
{
  return global_config;
}
void
FcgiPluginData::setGlobalConfigObj(FcgiPluginConfig *config)
{
